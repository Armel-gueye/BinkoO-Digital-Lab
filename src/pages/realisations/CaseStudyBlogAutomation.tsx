...
const pipelineSteps = [
  ...
  { icon: Bot, label: 'Génération titre IA', color: 'from-blue-500 to-indigo-500' },
  ...
  { icon: FileText, label: 'Rédaction 2 000 mots', color: 'from-red-500 to-red-600' },
  { icon: Code2, label: 'Mise en forme HTML', color: 'from-amber-500 to-yellow-600' },
  { icon: ImageIcon, label: 'Image Unsplash', color: 'from-teal-500 to-cyan-500' },
