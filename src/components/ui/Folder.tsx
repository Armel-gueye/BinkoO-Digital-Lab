  ...
  return (
    <div style={scaleStyle} className={className}>
      <div className={folderClassName} style={folderStyle} onClick={handleClick}>
        <div className="folder__back" style={isGradient ? { background: folderBackColor } : {}}>
          {papers.map((item, i) => (
            <div
              key={i}
          ...
          <div className="folder__front" style={isGradient ? { background: color } : {}}></div>
          <div className="folder__front right" style={isGradient ? { background: color } : {}}></div>
        </div>
      </div>
    </div>
  );
